...
nav[class^="sidebar_"]
  > div:not([aria-label="User Settings"]) > div[aria-label="Stickers"],        /* Remove Stickers in Server */
...
div[class^="progress_"],                                                       /*                                        */
nav[class^="sidebar_"]
  > div:not([aria-label="User Settings"]) > div[aria-label="App Directory"],   /* Remove App Directory in Server */
div[id="guild-context-guild-settings--APP_DIRECTORY"],                         /* Remove App Directory in Server Right-click */
nav[class^="sidebar_"]
